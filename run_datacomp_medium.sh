...
########################### DataComp-Medium ###########################
datasets_scale='medium' # Dictionary datacomp_small or datacomp_medium

fraction=0.3 # fraction for CLIP score filtering
fraction_vas=0.2 # fraction for VAS filtering
